package com.dpoints.view.module.login
...
import com.dpoints.dpointsmerchant.view.module.login.ForgotPasswordActivity
    ...
    override fun init() {
        ...
        iv_show_password.setOnClickListener {
            if(et_password.transformationMethod != null) {
                ...
                iv_show_password.setImageDrawable(getDrawable(R.drawable.ic_hide_password))
            }
            else {
                et_password.transformationMethod = PasswordTransformationMethod()
                iv_show_password.setImageDrawable(getDrawable(R.drawable.ic_show_password))
            }
...
//                Log.d("ERROR HASH:", e.message);
//        } catch (e: NoSuchAlgorithmException) {
//                Log.d("ERROR HASH:", e.message);
//        }

        //Log.d("chaa", viewModel.verifyState.toString())
...
//                    onSocialLoginSuccess()
    ...
    private fun login(email: String, password:String ) {
        if (validateLogin()) {
            viewModel.login(email, password, getFirebseToken())
        }

    }


    private fun validateLogin() = when {
